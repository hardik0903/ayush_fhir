...
async function autoMapBodyRegions() {
    try {
        console.log('🤖 Starting intelligent auto-mapping...\n');

        // Get all body regions
        const regionsResult = await db.query('SELECT id, code FROM body_regions');
        ...
        for (const region of regions) {
            ...
            console.log(`✓ ${region.code.padEnd(10)} → ${regionMappings} mappings created`);
        }

        console.log(`\n✅ Auto-mapping complete!`);
        console.log(`📊 Total mappings created: ${totalMappings}`);
        console.log(`\n💡 Next step: Review and verify mappings in the admin UI`);
